// src/components/forms/CambioForm.tsx
...
const CambioForm: React.FC<CambioFormProps> = ({ 
  ...
  const defaultInitialValues: CambioAceiteFormValues = {
    ...
    filtroAceite: false,
    filtroAceiteNota: 'Cambio S/N',
    filtroAire: false,
    filtroAireNota: 'Cambio S/N',
    filtroCombustible: false,
    filtroCombustibleNota: 'Cambio S/N',
    filtroHabitaculo: false,
    filtroHabitaculoNota: 'Cambio S/N',
    aditivo: false,
    aditivoNota: 'Cambio S/N',
    engrase: false,
    engraseNota: 'Cambio S/N',
    refrigerante: false,
    refrigeranteNota: 'Cambio S/N',
    caja: false,
    cajaNota: 'Cambio S/N',
    diferencial: false,
    diferencialNota: 'Cambio S/N',
    observaciones: '',
    ...initialValues
  };
  ...
  const handleKmChange = (
    ...
    // Actualizar el kilometraje del próximo cambio (por defecto +5000 km)
    const kmProximo = calculateNextKm(kmActuales, 5000);
                  ...
                  <View style={styles.row}>
                    ...
                    <View style={styles.halfInput}>
                      <TextInput
                        ...
                        style={styles.input}
                        mode="outlined"
                        left={<TextInput.Icon icon="oil" color={colors.primary} />}
                      />
                  ...
                  <View style={styles.serviceItem}>
                    <View style={styles.serviceHeader}>
                      <Text style={styles.serviceTitle}>Filtro de Aceite</Text>
                        ...
                        onValueChange={(value) => {
                            setFieldValue('filtroAceite', value);
                        }}
                    ...
                    {touched.filtroAceiteNota && errors.filtroAceiteNota && (
                      <HelperText type="error">{errors.filtroAceiteNota}</HelperText>
                    )}
                  </View>
                  ...
                  <View style={styles.serviceItem}>
                    <View style={styles.serviceHeader}>
                      ...
                      <Switch
                        ...
                        onValueChange={(value) => {setFieldValue('filtroAire', value);}}
                    ...
                    {touched.filtroAireNota && errors.filtroAireNota && (
                      <HelperText type="error">{errors.filtroAireNota}</HelperText>
                    )}
                  </View>
                  ...
                  <View style={styles.serviceItem}>
                    <View style={styles.serviceHeader}>
                      ...
                      <Switch
                        ...
                        onValueChange={(value) => {setFieldValue('filtroCombustible', value);}}
                        color={colors.primary}
                      />
                    </View>
                    ...
                    {touched.filtroCombustibleNota && errors.filtroCombustibleNota && (
                      <HelperText type="error">{errors.filtroCombustibleNota}</HelperText>
                    )}
                  </View>
                  ...
                  <View style={styles.serviceItem}>
                    <View style={styles.serviceHeader}>
                      ...
                      <Switch
                        ...
                        onValueChange={(value) => {setFieldValue('filtroHabitaculo', value);}}
                        color={colors.primary}
                      />
                    </View>
                    ...
                    <TextInput
                      ...
                      error={touched.filtroHabitaculoNota && !!errors.filtroHabitaculoNota}
                      style={styles.serviceInput}
                      mode="outlined"
                    />
                    {touched.filtroHabitaculoNota && errors.filtroHabitaculoNota && (
                      <HelperText type="error">{errors.filtroHabitaculoNota}</HelperText>
                    )}
                  </View>
                </Card.Content>
              </Card>
                ...
                <Card.Content>
                  ...
                  <View style={styles.serviceItem}>
                    <View style={styles.serviceHeader}>
                      ...
                      <Switch
                        ...
                        onValueChange={(value) => {setFieldValue('aditivo', value);}}
                        color={colors.primary}
                      />
                    </View>
                    ...
                    {touched.aditivoNota && errors.aditivoNota && (
                      <HelperText type="error">{errors.aditivoNota}</HelperText>
                    )}
                  </View>
                  ...
                  <View style={styles.serviceItem}>
                    <View style={styles.serviceHeader}>
                      ...
                      <Switch
                        ...
                        onValueChange={(value) => {setFieldValue('engrase', value);}}
                        color={colors.primary}
                      />
                    </View>
                    ...
                    {touched.engraseNota && errors.engraseNota && (
                      <HelperText type="error">{errors.engraseNota}</HelperText>
                    )}
                  </View>
                  ...
                  <View style={styles.serviceItem}>
                    <View style={styles.serviceHeader}>
                      ...
                      <Switch
                        ...
                        onValueChange={(value) => {setFieldValue('refrigerante', value);}}
                        color={colors.primary}
                      />
                    </View>
                    ...
                    {touched.refrigeranteNota && errors.refrigeranteNota && (
                      <HelperText type="error">{errors.refrigeranteNota}</HelperText>
                    )}
                  </View>
                  ...
                  <View style={styles.serviceItem}>
                    <View style={styles.serviceHeader}>
                      ...
                      <Switch
                        value={values.caja}
                        onValueChange={(value) => {setFieldValue('caja', value);}}
                        color={colors.primary}
                      />
                    </View>
                    ...
                    {touched.cajaNota && errors.cajaNota && (
                      <HelperText type="error">{errors.cajaNota}</HelperText>
                    )}
                  </View>
                  ...
                  <View style={styles.serviceItem}>
                    <View style={styles.serviceHeader}>
                      ...
                      <Switch
                        ...
                        onValueChange={(value) =>{setFieldValue('diferencial', value);}}
                        color={colors.primary}
                      />
                    </View>
                    ...
                    {touched.diferencialNota && errors.diferencialNota && (
                      <HelperText type="error">{errors.diferencialNota}</HelperText>
                    )}
                  </View>
                </Card.Content>
              </Card>
